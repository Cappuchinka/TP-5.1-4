...
public final class FragmentAuthBinding implements ViewBinding {
  ...
  private FragmentAuthBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonLogin,
      @NonNull Button buttonRegistration, @NonNull ConstraintLayout frameLayout6) {
  ...
  public static FragmentAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAuthBinding((ConstraintLayout) rootView, buttonLogin, buttonRegistration,
          frameLayout6);
    }
