...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  @NonNull
  public final ScrollView scrollFavorites;

  private FragmentFavoriteBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rVFavorites, @NonNull ScrollView scrollFavorites) {
    this.rootView = rootView;
    this.rVFavorites = rVFavorites;
    this.scrollFavorites = scrollFavorites;
  }
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.r_v_favorites;
      RecyclerView rVFavorites = ViewBindings.findChildViewById(rootView, id);
      if (rVFavorites == null) {
        break missingId;
      }

      id = R.id.scroll_favorites;
      ScrollView scrollFavorites = ViewBindings.findChildViewById(rootView, id);
      if (scrollFavorites == null) {
        break missingId;
      }

      return new FragmentFavoriteBinding((ConstraintLayout) rootView, rVFavorites, scrollFavorites);
    }
